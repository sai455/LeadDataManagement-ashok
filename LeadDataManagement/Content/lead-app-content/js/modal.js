'use strict'; $(document).ready(function () {
    document.querySelector('.alert-confirm').onclick = function ()
    {
        swal({
            ...
            type: "warning", showCancelButton: true, confirmButtonClass: "btn-danger", confirmButtonText: "Yes, delete it!", closeOnConfirm: false
        },
    ...
    document.querySelector('.alert-success-cancel').onclick = function ()
    {
        swal({
            ...
            type: "warning", showCancelButton: true, confirmButtonClass: "btn-danger", confirmButtonText: "Yes, delete it!", cancelButtonText: "No, cancel plx!", closeOnConfirm: false, closeOnCancel: false
    ...
    document.querySelector('.alert-prompt').onclick = function () {
        swal({
            ...
            type: "input", showCancelButton: true, closeOnConfirm: false, inputPlaceholder: "Write something"
        }, function (inputValue) {
